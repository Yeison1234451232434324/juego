 ...
 */
const DEFS = [
  { key: "supplier",  name: "Proveedor confiable",       cost: 120, category: "Logística",
    desc: "Cada reto que resuelvas te da +2 materiales extra. Necesitarás menos retos por pedido." },
  { key: "toolkit",   name: "Kit de herramientas nuevo", cost: 220, category: "Producción",
    desc: "Mario fabrica un 15% más rápido." },
  { key: "organizer", name: "Organizador de materiales", cost: 300, category: "Programación",
    desc: "El panel de objetivos te dice cuántos retos te faltan para completar el pedido." },
  { key: "analyzer",  name: "Analizador de código",      cost: 450, category: "Programación",
    desc: "Cuando fallas un reto, te muestra la pista concreta automáticamente." },
  { key: "bench",     name: "Banco reforzado",           cost: 700, category: "Producción",
    desc: "Mario fabrica un 25% más rápido (se suma al kit de herramientas)." },
  { key: "auto",      name: "Producción automática",     cost: 1100, category: "Logística",
